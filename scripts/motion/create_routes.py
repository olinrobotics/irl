...
class RouteCreator:
    ...
    def create_route_dictionary(self):
        ...
        self.route_dictionary["R_ttt"] = "R_ttt; 200, 2400, 1800, 720, 240, 2.1"
        ...
        for r in self.route_dictionary.keys():
    ...
    def create_callback(self, cmd_raw):
        missed_route = cmd_raw

        if "HOMING DONE" in cmd_raw.data:
            self.create_route_dictionary()

        route = self.route_dictionary.get(missed_route.split(" ")[1], None)
