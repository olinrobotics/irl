#ifndef _ROS_irl_Edwin_Shape_h
#define _ROS_irl_Edwin_Shape_h
...
namespace irl
{
  ...
  class Edwin_Shape : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "irl/Edwin_Shape"; };
    const char * getMD5(){ return "5d5d01b8fb9a9b0cd9556e64e8ba3e61"; };
