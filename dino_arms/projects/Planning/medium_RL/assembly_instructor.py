...
class Assembler(object):
    ...
    def __init__(self):
        ...
        self.plane_mapping = {"[0, 0, 0]":0,  "[1, 0, 0]":10,  "[2, 0, 0]":20, "[3, 0, 0]":15,  "[4, 0, 0]":5, \
                              "[0, 1, 0]":1,  "[1, 1, 0]":11,  "[2, 1, 0]":21, "[3, 1, 0]":16,  "[4, 1, 0]":6, \
                              "[0, 2, 0]":2,  "[1, 2, 0]":12,  "[2, 2, 0]":22, "[3, 2, 0]":17, "[4, 2, 0]":7, \
                              "[0, 3, 0]":3,  "[1, 3, 0]":13,  "[2, 3, 0]":23, "[3, 3, 0]":18,  "[4, 3, 0]":8, \
                              "[0, 4, 0]":4,  "[1, 4, 0]":14,  "[2, 4, 0]":24, "[3, 4, 0]":19,  "[4, 4, 0]":9 }
