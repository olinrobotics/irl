...
class RouteCreator(object):
    ...
    def create_route_dictionary(self):
        ...
        ###################               Sudoku actions               #####################
        self.route_dictionary['R_sudoku_center'] = "R_sudoku_center; 0, 3400, 4700, 857, 22, 0"
    ...
    def setup_initial_routes(self):
        inital_routes = ["R_ttt", "R_laugh", "R_nudge", "R_look", "R_sad_turn", "R_get_set", "R_sudoku_center"]
