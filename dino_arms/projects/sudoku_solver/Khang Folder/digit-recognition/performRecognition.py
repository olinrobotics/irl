...
#     black_background = np.full((length, length), 0, dtype="uint8")
#     black_background[y_offset:y_offset + rect[3], x_offset:x_offset + rect[2]] = digit_rectangle
#
#     # Resize the image
#     roi = cv2.resize(black_background, (28, 28), interpolation=cv2.INTER_AREA)
